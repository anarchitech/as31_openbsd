...
#
# 2023-01-15: Revised by The Anarchitech Collective for OpenBSD!
#
...
CFLAGS=-O3 -Wall
CC=cc    # We don't use gcc on OpenBSD. ;)
...
all: as31 # as31_gtk  # gtk? Nein danke!
...
# gtk?!!? es ist bei Strafe verboten! 
